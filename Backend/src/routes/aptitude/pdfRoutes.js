...
import { uploadPdfFile, getPdfs, deletePdf, getPdfById, updatePdf, getSignature,} from '../../controllers/aptitude/pdfController.js';
...
router.get('/sign', adminMiddleware, getSignature);
