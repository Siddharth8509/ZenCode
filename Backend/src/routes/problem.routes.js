...
import { createProblem, createProblemsBulk, getProblemById, problemFetchAll, updateProblem, solvedProblemByUser, deleteProblem, getSubmission, getUserActivity } from "../controllers/problem.controller.js"
...
problemRouter.post("/create-bulk", adminMiddleware, createProblemsBulk);
